...
ifneq (arm,$(HOSTARCH))
ifeq (windows,$(HOSTOS))
GOPREFIX += CC=arm-linux-gnueabihf-gcc CGO_LDFLAGS="-g -O2 -LC:\msys64\opt\gcc-linaro-4.9.4-2017.01-i686-mingw32_arm-linux-gnueabihf\arm-linux-gnueabihf\lib -Wl,-rpath-link C:\msys64\opt\gcc-linaro-4.9.4-2017.01-i686-mingw32_arm-linux-gnueabihf\arm-linux-gnueabihf\lib" 
else
ifeq (1,$(USEZMQ))
GOPREFIX += PKG_CONFIG_PATH=/usr/local/zeromq-4.2.2/arm/lib/pkgconfig CC=arm-linux-gnueabihf-gcc CGO_CFLAGS="-g -O2 -I/usr/local/zeromq-4.2.2/arm/include" CGO_LDFLAGS="-g -O2 -L/usr/local/zeromq-4.2.2/arm/lib -L/usr/arm-linux-gnueabihf/lib -Wl,-rpath-link /usr/local/zeromq-4.2.2/arm/lib -Wl,-rpath-link /usr/arm-linux-gnueabihf/lib" 
else
GOPREFIX += CC=arm-linux-gnueabihf-gcc CGO_LDFLAGS="-g -O2 -L/usr/arm-linux-gnueabihf/lib -Wl,-rpath-link /usr/arm-linux-gnueabihf/lib" 
endif
endif
endif
endif
